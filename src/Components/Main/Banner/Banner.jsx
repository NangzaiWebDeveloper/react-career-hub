...
const Banner = () => {
    return (
        <div className='bg-[#FFF]'>
            <div className='md:flex max-w-6xl mx-auto md:mt-28'>
                <div className=' w-[50%] border-gray-600'>
                    <h1 className='font-extrabold text-xl md:text-7xl'>One Step <br />Closer To Your <br />Dream Job</h1>
